...
"""
RaceWax Oracle v10 — forecast + wax model + Plotly figure builders for Django.

Adapted from the macOS bundle script
``RaceWax Oracle V10.app/Contents/Resources/racewax_oracle_v10.py`` (Streamlit UI stripped).
glideCast / Race Wax Craft supplies login, billing, and templates.
"""
...
SUPPORT_DIR = Path(os.path.expanduser("~/Library/Application Support/RaceWaxOracleV10"))
...
VENUES = {
    ...
    # --- Andorra ---
    "Soldeu": {
        # Àliga/Gran Valira — north-facing (Finals venue; FIS raceid=114125/130/132/118480/81)
        ...
        "slope_deg": 20.0,
        "finish_ft": 5659,
        "starts_ft": {"DH": 7989, "SuperG": 7628, "GS": 7303, "SL": 6700},
        "points": {
            "Upper NWS point": {"lat": 42.5681, "lon": 1.6714, "elev_ft": 7989},
            "Lower NWS point": {"lat": 42.5744, "lon": 1.6672, "elev_ft": 5659},
        },
    },

    # --- Austria ---
    "Altenmarkt-Zauchensee": {
        # Emma Piste — north-facing speed course (FIS raceid=118465/118349)
        ...
        "slope_deg": 22.0,
        "finish_ft": 4527,
        "starts_ft": {"DH": 7139, "SuperG": 6152},
        "points": {
            "Upper NWS point": {"lat": 47.3644, "lon": 13.3578, "elev_ft": 7139},
            "Lower NWS point": {"lat": 47.3744, "lon": 13.3650, "elev_ft": 4527},
        },
    },
    "Flachau": {
        # Hermann Maier Weltcupstrecke night SL — north-facing (FIS raceid=122810)
        ...
        "starts_ft": {"SL": 3835},
        "points": {
            "Upper NWS point": {"lat": 47.3297, "lon": 13.3836, "elev_ft": 3835},
            "Lower NWS point": {"lat": 47.3397, "lon": 13.3936, "elev_ft": 3150},
        },
    },
    "Hinterstoder": {
        # Hannes-Trinkl-Weltcupstrecke — NNE-facing (FIS raceid=100158/100113; no WC SL held)
        ...
        "slope_deg": 22.0,
        "finish_ft": 2119,
        "starts_ft": {"SuperG": 4239, "GS": 3517},
        "points": {
            "Upper NWS point": {"lat": 47.6894, "lon": 14.1422, "elev_ft": 4239},
            "Lower NWS point": {"lat": 47.6994, "lon": 14.1522, "elev_ft": 2119},
        },
    },
    "Kitzbühel": {
        # Streif DH/SG faces NNW; Ganslernhang SL faces NE (FIS raceid=122820/19/21)
        ...
        "slope_deg": 27.0,
        "finish_ft": 2641,
        "starts_ft": {"DH": 5463, "SuperG": 4413, "SL": 3294},
        "points": {
            "Upper NWS point": {"lat": 47.4250, "lon": 12.3800, "elev_ft": 5463},
            "Lower NWS point": {"lat": 47.4457, "lon": 12.3908, "elev_ft": 2641},
        },
    },
    "Mayrhofen": {
        # Night SL on Ahorn — north-facing (historical WC SL 1997-2007; ~1900m start/~1650m finish, topographic estimate)
        ...
        "starts_ft": {"SL": 6234},
        "points": {
            "Upper NWS point": {"lat": 47.1594, "lon": 11.8581, "elev_ft": 6234},
            "Lower NWS point": {"lat": 47.1694, "lon": 11.8681, "elev_ft": 5413},
        },
    },
    "Pitztal": {
    ...
    "Saalbach": {
        # Schattberg/Hinterglemm — north-facing (2025 Worlds; FIS raceid=118505/503/495/497)
        ...
        "slope_deg": 22.0,
        "finish_ft": 3511,
        "starts_ft": {"DH": 6004, "SuperG": 5338, "GS": 4869, "SL": 4196},
        "points": {
            "Upper NWS point": {"lat": 47.3867, "lon": 12.6394, "elev_ft": 6004},
            "Lower NWS point": {"lat": 47.3967, "lon": 12.6494, "elev_ft": 3511},
        },
    },
    "Schladming": {
        # Planai — NNW-facing; SL Nightrace start is mid-mountain (FIS raceid=122826/122827)
        ...
        "slope_deg": 18.0,
        "finish_ft": 2441,
        "starts_ft": {"SL": 3445, "GS": 3143},
        "points": {
            "Upper NWS point": {"lat": 47.3836, "lon": 13.6847, "elev_ft": 3445},
            "Lower NWS point": {"lat": 47.3936, "lon": 13.6947, "elev_ft": 2441},
        },
    },
    "Semmering": {
        # Hirschenkogel / Giganten course — NE-facing (FIS raceid=123079/123080)
        ...
        "slope_deg": 14.0,
        "finish_ft": 3346,
        "starts_ft": {"GS": 4379, "SL": 4036},
        "points": {
            "Upper NWS point": {"lat": 47.6347, "lon": 15.8264, "elev_ft": 4379},
            "Lower NWS point": {"lat": 47.6447, "lon": 15.8364, "elev_ft": 3346},
        },
    },
    "Sölden": {
    ...
    # --- Bulgaria ---
    "Bansko": {
        # Todorka/Banderishka Polyana — NE-facing (FIS raceid=100043/100064/118558/118559)
        ...
        "slope_deg": 22.0,
        "finish_ft": 5282,
        "starts_ft": {"DH": 7923, "SuperG": 7267, "GS": 6759, "SL": 6004},
        "points": {
            "Upper NWS point": {"lat": 41.7900, "lon": 23.4683, "elev_ft": 7923},
            "Lower NWS point": {"lat": 41.8000, "lon": 23.4783, "elev_ft": 5282},
        },
    },

    # --- Czech Republic ---
    "Spindlerův Mlýn": {
        # Medvědín/Obří sjezd — NNE-facing (FIS raceid=114202/95583)
        ...
        "slope_deg": 15.0,
        "finish_ft": 2483,
        "starts_ft": {"GS": 3740, "SL": 3097},
        "points": {
            "Upper NWS point": {"lat": 50.7189, "lon": 15.6008, "elev_ft": 3740},
            "Lower NWS point": {"lat": 50.7289, "lon": 15.6108, "elev_ft": 2483},
        },
    },

    # --- Finland ---
    "Levi": {
        # Levi/Tähtiniemi — north-facing, tight WC SL (FIS raceid=122762/122763)
        ...
        "starts_ft": {"SL": 1437},
        "points": {
            "Upper NWS point": {"lat": 67.7783, "lon": 24.8283, "elev_ft": 1437},
            "Lower NWS point": {"lat": 67.7883, "lon": 24.8383, "elev_ft": 846},
        },
    },
    "Ruka": {
    ...
    # --- France ---
    "Chamonix": {
        # Les Houches / Piste Verte — NNW-facing (FIS raceid=82820/118557; no WC GS held)
        ...
        "slope_deg": 20.0,
        "finish_ft": 3232,
        "starts_ft": {"DH": 6168, "SL": 3835},
        "points": {
            "Upper NWS point": {"lat": 45.8797, "lon": 6.8094, "elev_ft": 6168},
            "Lower NWS point": {"lat": 45.8897, "lon": 6.8194, "elev_ft": 3232},
        },
    },
    "Courchevel": {
        # Emile Allais course — NE-facing (FIS raceid=123081/104376)
        ...
        "slope_deg": 18.0,
        "finish_ft": 5922,
        "starts_ft": {"GS": 7136, "SL": 6611},
        "points": {
            "Upper NWS point": {"lat": 45.4000, "lon": 6.6478, "elev_ft": 7136},
            "Lower NWS point": {"lat": 45.4100, "lon": 6.6578, "elev_ft": 5922},
        },
    },
    "Méribel": {
        # Roc de Fer (2015 WC Finals DH/SG) — north-facing (FIS raceid=78979/80/81/82)
        ...
        "slope_deg": 24.0,
        "finish_ft": 4698,
        "starts_ft": {"DH": 7379, "SuperG": 6430},
        "points": {
            "Upper NWS point": {"lat": 45.3783, "lon": 6.5578, "elev_ft": 7379},
            "Lower NWS point": {"lat": 45.3883, "lon": 6.5678, "elev_ft": 4698},
        },
    },
    "Val d'Isère": {
        # Bellevarde / Oreiller-Killy (DH,SG) + La Face (GS) — north-facing (FIS raceid=107381/82/122781/82)
        ...
        "slope_deg": 25.0,
        "finish_ft": 5938,
        "starts_ft": {"DH": 8877, "SuperG": 7536, "GS": 7428, "SL": 6749},
        "points": {
            "Upper NWS point": {"lat": 45.4397, "lon": 6.9453, "elev_ft": 8877},
            "Lower NWS point": {"lat": 45.4497, "lon": 6.9553, "elev_ft": 5938},
        },
    },

    # --- Germany ---
    "Garmisch-Partenkirchen": {
        # Kandahar DH/SG — NNE-facing; SL on Gudiberg, GS on Steilhang (FIS raceid=122824/25/104332/31/109057/100147)
        ...
        "slope_deg": 22.0,
        "finish_ft": 2461,
        "starts_ft": {"DH": 4888, "SuperG": 4291, "GS": 3543, "SL": 3091},
        "points": {
            "Upper NWS point": {"lat": 47.4967, "lon": 11.0683, "elev_ft": 4888},
            "Lower NWS point": {"lat": 47.5067, "lon": 11.0783, "elev_ft": 2461},
        },
    },
    "Ofterschwang": {
        # Ofterschwanger Horn — north-facing (FIS raceid=91020/91021)
        ...
        "slope_deg": 14.0,
        "finish_ft": 3018,
        "starts_ft": {"GS": 4265, "SL": 3658},
        "points": {
            "Upper NWS point": {"lat": 47.5753, "lon": 10.2086, "elev_ft": 4265},
            "Lower NWS point": {"lat": 47.5853, "lon": 10.2186, "elev_ft": 3018},
        },
    },

    # --- Italy ---
    "Alta Badia": {
        # Gran Risa — north-facing (FIS raceid=122789/122790)
        ...
        "slope_deg": 18.0,
        "finish_ft": 4659,
        "starts_ft": {"GS": 6129, "SL": 5282},
        "points": {
            "Upper NWS point": {"lat": 46.5878, "lon": 11.9047, "elev_ft": 6129},
            "Lower NWS point": {"lat": 46.5978, "lon": 11.9147, "elev_ft": 4659},
        },
    },
    "Bormio": {
        # Stelvio — NNE-facing; long DH with big vertical (FIS raceid=122793/122794)
        ...
        "slope_deg": 22.0,
        "finish_ft": 4085,
        "starts_ft": {"DH": 7441, "SuperG": 6427},
        "points": {
            "Upper NWS point": {"lat": 46.4600, "lon": 10.3670, "elev_ft": 7441},
            "Lower NWS point": {"lat": 46.4700, "lon": 10.3770, "elev_ft": 4085},
        },
    },
    "Cortina d'Ampezzo": {
        # Olympia delle Tofane — NW-facing (FIS raceid=122813/122814; no WC GS held)
        ...
        "slope_deg": 22.0,
        "finish_ft": 5118,
        "starts_ft": {"DH": 7612, "SuperG": 7201},
        "points": {
            "Upper NWS point": {"lat": 46.5230, "lon": 12.1328, "elev_ft": 7612},
            "Lower NWS point": {"lat": 46.5330, "lon": 12.1428, "elev_ft": 5118},
        },
    },
    "Madonna di Campiglio": {
        # 3Tre — north-facing compact SL (FIS raceid=122797)
        ...
        "starts_ft": {"SL": 5659},
        "points": {
            "Upper NWS point": {"lat": 46.2244, "lon": 10.8203, "elev_ft": 5659},
            "Lower NWS point": {"lat": 46.2344, "lon": 10.8303, "elev_ft": 5069},
        },
    },
    "Santa Caterina Valfurva": {
        # Deborah Compagnoni course — NE-facing (FIS raceid=86824/86806)
        ...
        "slope_deg": 24.0,
        "finish_ft": 5725,
        "starts_ft": {"DH": 8924, "SuperG": 7858},
        "points": {
            "Upper NWS point": {"lat": 46.4117, "lon": 10.4783, "elev_ft": 8924},
            "Lower NWS point": {"lat": 46.4217, "lon": 10.4883, "elev_ft": 5725},
        },
    },
    "Sestriere": {
        # Borgata course — north-facing (FIS raceid=122774/122836)
        ...
        "slope_deg": 18.0,
        "finish_ft": 6706,
        "starts_ft": {"GS": 7874, "SL": 7382},
        "points": {
            "Upper NWS point": {"lat": 44.9547, "lon": 6.8747, "elev_ft": 7874},
            "Lower NWS point": {"lat": 44.9647, "lon": 6.8847, "elev_ft": 6706},
        },
    },
    "Val Gardena": {
        # Saslong — NW-facing (faces the Langkofel massif) (FIS raceid=122788/122787)
        ...
        "slope_deg": 22.0,
        "finish_ft": 4626,
        "starts_ft": {"DH": 7379, "SuperG": 6594},
        "points": {
            "Upper NWS point": {"lat": 46.5500, "lon": 11.7728, "elev_ft": 7379},
            "Lower NWS point": {"lat": 46.5600, "lon": 11.7828, "elev_ft": 4626},
        },
    },

    # --- Norway ---
    "Kvitfjell": {
        # Kvitfjell Alpinsenter — north-facing; WC DH/SG only (GS at Hafjell) (FIS raceid=122830/122847)
        ...
        "slope_deg": 25.0,
        "finish_ft": 597,
        "starts_ft": {"DH": 3346, "SuperG": 2326},
        "points": {
            "Upper NWS point": {"lat": 61.4778, "lon": 10.1633, "elev_ft": 3346},
            "Lower NWS point": {"lat": 61.4878, "lon": 10.1733, "elev_ft": 597},
        },
    },
    "Hafjell": {
        # Hafjell — north-facing; WC GS during Norwegian double-header (FIS raceid=122850)
        "display_name": "Hafjell Wax Tool",
        "course_name": "Hafjell Race Venue",
        "region": "europe",
        "weather_api": "open-meteo",
        "lat": 61.3711,
        "lon": 10.4756,
        ...
        "starts_ft": {"GS": 2113},
        "points": {
            "Upper NWS point": {"lat": 61.3661, "lon": 10.4706, "elev_ft": 2113},
            "Lower NWS point": {"lat": 61.3761, "lon": 10.4806, "elev_ft": 896},
        },
    },
    "Narvik": {
        # Fagernesfjellet — north-facing Arctic SL (last WC 1997; summit 578m, topographic estimate)
        ...
        "starts_ft": {"SL": 1804},
        "points": {
            "Upper NWS point": {"lat": 68.4083, "lon": 17.3969, "elev_ft": 1804},
            "Lower NWS point": {"lat": 68.4183, "lon": 17.4069, "elev_ft": 427},
        },
    },

    # --- Slovakia ---
    "Jasná": {
        # Chopok north face — north-facing (WC GS/SL only; FIS raceid=118468/118469)
        ...
        "slope_deg": 20.0,
        "finish_ft": 4101,
        "starts_ft": {"GS": 5413, "SL": 4757},
        "points": {
            "Upper NWS point": {"lat": 48.9258, "lon": 19.5894, "elev_ft": 5413},
            "Lower NWS point": {"lat": 48.9358, "lon": 19.5994, "elev_ft": 4101},
        },
    },

    # --- Slovenia ---
    "Kranjska Gora": {
        # Vitranc — NW-facing; classic WC GS/SL venue (FIS raceid=122842/122843)
        ...
        "slope_deg": 18.0,
        "finish_ft": 2766,
        "starts_ft": {"GS": 4193, "SL": 3406},
        "points": {
            "Upper NWS point": {"lat": 46.4747, "lon": 13.7686, "elev_ft": 4193},
            "Lower NWS point": {"lat": 46.4847, "lon": 13.7786, "elev_ft": 2766},
        },
    },

    # --- Sweden ---
    "Åre": {
        # Areskutan — north-facing; hosts full WC programme (FIS raceid=91050-56/122848/49)
        ...
        "slope_deg": 20.0,
        "finish_ft": 1286,
        "starts_ft": {"DH": 3389, "SuperG": 2956, "GS": 2369, "SL": 1923},
        "points": {
            "Upper NWS point": {"lat": 63.3900, "lon": 13.0625, "elev_ft": 3389},
            "Lower NWS point": {"lat": 63.4000, "lon": 13.0725, "elev_ft": 1286},
        },
    },

    # --- Switzerland ---
    "Adelboden": {
        # Chuenisbärgli — NNW-facing; classic GS venue (FIS raceid=122802/122803)
        ...
        "slope_deg": 16.0,
        "finish_ft": 4272,
        "starts_ft": {"GS": 5676, "SL": 4964},
        "points": {
            "Upper NWS point": {"lat": 46.4750, "lon": 7.5500, "elev_ft": 5676},
            "Lower NWS point": {"lat": 46.4850, "lon": 7.5600, "elev_ft": 4272},
        },
    },
    "Crans-Montana": {
        # Downhill of Champions — south-facing (sun-exposed, unique) (FIS raceid=118485/118749)
        ...
        "slope_deg": 18.0,
        "finish_ft": 5069,
        "starts_ft": {"DH": 7251, "SuperG": 6942},
        "points": {
            "Upper NWS point": {"lat": 46.2944, "lon": 7.4978, "elev_ft": 7251},
            "Lower NWS point": {"lat": 46.3044, "lon": 7.5078, "elev_ft": 5069},
        },
    },
    "Lenzerheide": {
        # Alp Farur / Cassons — NE-facing; season-finale venue (FIS raceid=104415-23)
        ...
        "slope_deg": 22.0,
        "finish_ft": 5020,
        "starts_ft": {"DH": 7513, "SuperG": 7087, "GS": 6299, "SL": 5741},
        "points": {
            "Upper NWS point": {"lat": 46.7178, "lon": 9.5631, "elev_ft": 7513},
            "Lower NWS point": {"lat": 46.7278, "lon": 9.5731, "elev_ft": 5020},
        },
    },
    "Meiringen-Hasliberg": {
        # Käserstatt / Hasliberg — NNW-facing; GS (WC races cancelled repeatedly; Planplatten 2245m; topographic estimate)
        ...
        "starts_ft": {"GS": 6299},
        "points": {
            "Upper NWS point": {"lat": 46.7300, "lon": 8.1919, "elev_ft": 6299},
            "Lower NWS point": {"lat": 46.7400, "lon": 8.2019, "elev_ft": 4921},
        },
    },
    "Veysonnaz": {
        # Mont-Rouge (4 Vallées) — NNW-facing (last WC 1993; Graoully course ~2000-2100m; topographic estimate)
        ...
        "slope_deg": 20.0,
        "finish_ft": 5085,
        "starts_ft": {"GS": 6890, "SL": 6234},
        "points": {
            "Upper NWS point": {"lat": 46.1378, "lon": 7.3194, "elev_ft": 6890},
            "Lower NWS point": {"lat": 46.1478, "lon": 7.3294, "elev_ft": 5085},
        },
    },
    "Wengen": {
        # Lauberhorn — east-facing (toward Kleine Scheidegg); no WC GS held (FIS raceid=122808/07/09)
        ...
        "slope_deg": 20.0,
        "finish_ft": 4216,
        "starts_ft": {"DH": 7595, "SuperG": 6644, "SL": 4839},
        "points": {
            "Upper NWS point": {"lat": 46.4890, "lon": 7.9103, "elev_ft": 7595},
            "Lower NWS point": {"lat": 46.4990, "lon": 7.9203, "elev_ft": 4216},
        },
    },
    "Zermatt": {
        # Matterhorn Glacier (high-altitude speed events) — north-facing (FIS raceid=118510/118338)
        ...
        "starts_ft": {"DH": 12205},
        "points": {
            "Upper NWS point": {"lat": 45.9792, "lon": 7.7308, "elev_ft": 12205},
            "Lower NWS point": {"lat": 45.9892, "lon": 7.7408, "elev_ft": 9318},
        },
    },
...
class ModelParams:
    ...
    albedo: float
    wet_lock_band_f: float
    wet_refreeze_strength: float
    wet_deep_relax_scale: float
...
def _wet_keywords_flag(series_text: pd.Series, phrases: list[str]) -> pd.Series:
    local = series_text.fillna("").str.lower()
    return local.apply(lambda t: any(p in t for p in phrases))


def _rolling_true_hours(flag: pd.Series, window: int) -> pd.Series:
    return flag.astype(float).rolling(window=window, min_periods=1).sum()


def _update_temp_with_wet_lock(prev_temp_f: float, net_fph: float, reserve_fh: float, wet_active: bool, lock_band_f: float) -> tuple[float, float, float]:
    lock_temp_f = 32.0
    latent_used_fh = 0.0
    if not wet_active:
        return float(np.clip(prev_temp_f + net_fph, -40.0, 32.0)), reserve_fh, latent_used_fh

    if prev_temp_f >= lock_temp_f - lock_band_f:
        if net_fph >= 0:
            return lock_temp_f, reserve_fh, latent_used_fh
        cooling = -net_fph
        if reserve_fh > 0.0:
            latent_used_fh = min(cooling, reserve_fh)
            reserve_fh -= latent_used_fh
            remaining = cooling - latent_used_fh
            if remaining <= 0.0:
                return lock_temp_f, reserve_fh, latent_used_fh
            return float(np.clip(lock_temp_f - remaining, -40.0, 32.0)), reserve_fh, latent_used_fh
        return float(np.clip(prev_temp_f + net_fph, -40.0, 32.0)), reserve_fh, latent_used_fh
...
def prepare_venue(df: pd.DataFrame, venue: dict, start_ft: float, finish_ft: float, params: ModelParams, race_date: pd.Timestamp) -> pd.DataFrame:
    ...
    out["combined_forecast_text"] = (out["forecast_upper"].fillna("") + " " + out["forecast_lower"].fillna("")).str.lower()
    out["max_pop_pct"] = out[["pop_upper_pct", "pop_lower_pct"]].max(axis=1).fillna(0.0)
    out["mean_air_f"] = out[["air_start_f", "air_finish_f"]].mean(axis=1)
    out["rain_mix_flag"] = (
        _wet_keywords_flag(out["combined_forecast_text"], ["rain", "drizzle", "showers", "freezing rain", "sleet", "wintry mix", "mix", "rain and snow", "rain/snow"])
        & (out["max_pop_pct"] >= 30.0)
    )
    out["warm_surface_flag"] = out["mean_air_f"] >= 31.5
    out["recent_rain_mix_hours"] = _rolling_true_hours(out["rain_mix_flag"], 18)
    out["recent_warm_hours"] = _rolling_true_hours(out["warm_surface_flag"], 18)
    ...
    out["recent_melt_flag"] = (out["recent_warm_hours"] >= 4.0) & (out["solar_norm"] >= 0.15)
    out["recent_thaw_refreeze_flag"] = (out["mean_air_f"].rolling(window=18, min_periods=1).max() >= 33.0) & (out["mean_air_f"] <= 31.0)
    out["wet_history_score"] = (
        1.2 * out["rain_mix_flag"].astype(float)
        + 0.12 * out["recent_rain_mix_hours"]
        + 0.08 * out["recent_warm_hours"]
        + 0.9 * out["recent_thaw_refreeze_flag"].astype(float)
        + 0.5 * out["recent_melt_flag"].astype(float)
    )
    out["wet_mode_flag"] = out["wet_history_score"] >= 0.75
    ...
    deep_relax_start = np.where(out["wet_mode_flag"], params.deep_auto_relax_coeff * params.wet_deep_relax_scale, params.deep_auto_relax_coeff)
    deep_relax_finish = np.where(out["wet_mode_flag"], params.deep_auto_relax_coeff * max(0.1, params.wet_deep_relax_scale * 0.85), params.deep_auto_relax_coeff)
    deep_start_vals = [float(deep_start_init)]
    deep_finish_vals = [float(deep_finish_init)]
    start_air_forcing = pd.to_numeric(out["air_start_f"], errors="coerce").ffill().bfill().to_numpy()
    finish_air_forcing = pd.to_numeric(out["air_finish_f"], errors="coerce").ffill().bfill().to_numpy()
    for i in range(1, len(out)):
        deep_start_prev = deep_start_vals[-1]
        deep_finish_prev = deep_finish_vals[-1]
        deep_start_vals.append(float(np.clip(deep_start_prev + deep_relax_start[i - 1] * (start_air_forcing[i - 1] - deep_start_prev), 0.0, 32.0)))
        deep_finish_vals.append(float(np.clip(deep_finish_prev + deep_relax_finish[i - 1] * (finish_air_forcing[i - 1] - deep_finish_prev), 0.0, 32.0)))
    out["deep_snow_start_f"] = pd.Series(deep_start_vals, index=out.index, dtype=float)
    out["deep_snow_finish_f"] = pd.Series(deep_finish_vals, index=out.index, dtype=float)

    snow_start = [float(out["deep_snow_start_f"].iloc[0])]
    snow_finish = [float(out["deep_snow_finish_f"].iloc[0])]
    freeze_reserve_start_fh = [float(max(0.0, params.wet_refreeze_strength * (0.6 + 0.7 * out["wet_history_score"].iloc[0])) if out["wet_mode_flag"].iloc[0] and snow_start[0] >= 31.5 else 0.0)]
    freeze_reserve_finish_fh = [float(max(0.0, 1.35 * params.wet_refreeze_strength * (0.6 + 0.7 * out["wet_history_score"].iloc[0])) if out["wet_mode_flag"].iloc[0] and snow_finish[0] >= 31.5 else 0.0)]
    latent_lock_start_fph = [0.0]
    latent_lock_finish_fph = [0.0]
    wet_active_start = [bool(out["wet_mode_flag"].iloc[0] and snow_start[0] >= 32.0 - params.wet_lock_band_f)]
    wet_active_finish = [bool(out["wet_mode_flag"].iloc[0] and snow_finish[0] >= 32.0 - params.wet_lock_band_f)]
    for i in range(1, len(out)):
        ...
        net_start = sensible_start + solar_term - clear_start + lw_start + latent_start + ground_start
        target_reserve_start = params.wet_refreeze_strength * max(0.0, 0.6 + 0.7 * row_prev["wet_history_score"])
        reserve_start = freeze_reserve_start_fh[-1]
        wet_start_now = bool(row_prev["wet_mode_flag"] and (prev_start >= 32.0 - params.wet_lock_band_f or reserve_start > 0.0))
        if wet_start_now:
            reserve_start = max(reserve_start, target_reserve_start)
        next_start, reserve_start, latent_used_start = _update_temp_with_wet_lock(prev_start, net_start, reserve_start, wet_start_now, params.wet_lock_band_f)
        ...
        net_finish = sensible_finish + solar_term - clear_finish + lw_finish + latent_finish + ground_finish
        target_reserve_finish = 1.35 * params.wet_refreeze_strength * max(0.0, 0.6 + 0.7 * row_prev["wet_history_score"])
        reserve_finish = freeze_reserve_finish_fh[-1]
        wet_finish_now = bool(row_prev["wet_mode_flag"] and (prev_finish >= 32.0 - params.wet_lock_band_f or reserve_finish > 0.0))
        if wet_finish_now:
            reserve_finish = max(reserve_finish, target_reserve_finish)
        next_finish, reserve_finish, latent_used_finish = _update_temp_with_wet_lock(prev_finish, net_finish, reserve_finish, wet_finish_now, params.wet_lock_band_f)

        snow_start.append(min(next_start, 32.0))
        snow_finish.append(min(next_finish, 32.0))
        freeze_reserve_start_fh.append(float(reserve_start))
        freeze_reserve_finish_fh.append(float(reserve_finish))
        latent_lock_start_fph.append(float(latent_used_start))
        latent_lock_finish_fph.append(float(latent_used_finish))
        wet_active_start.append(bool(wet_start_now))
        wet_active_finish.append(bool(wet_finish_now))
    out["snow_start_pred_f"] = snow_start
    out["snow_finish_pred_f"] = snow_finish
    out["freeze_reserve_start_fh"] = freeze_reserve_start_fh
    out["freeze_reserve_finish_fh"] = freeze_reserve_finish_fh
    out["latent_lock_start_fph"] = latent_lock_start_fph
    out["latent_lock_finish_fph"] = latent_lock_finish_fph
    out["wet_active_start"] = wet_active_start
    out["wet_active_finish"] = wet_active_finish
    ...
    out["effective_net_start_fph"] = out["net_start_fph"] + out["latent_lock_start_fph"]
    out["effective_net_finish_fph"] = out["net_finish_fph"] + out["latent_lock_finish_fph"]
    for col in ["solar_fph","sensible_start_fph","sensible_finish_fph","clear_night_start_fph","clear_night_finish_fph","longwave_start_fph","longwave_finish_fph","latent_start_fph","latent_finish_fph","ground_start_fph","ground_finish_fph","net_start_fph","net_finish_fph","latent_lock_start_fph","latent_lock_finish_fph","effective_net_start_fph","effective_net_finish_fph"]:
...
def classify_glide_regime(start_snow_f: float, finish_snow_f: float, start_air_f: float, finish_air_f: float, rh_pct: float, snow_type: str, melt_flag: bool) -> tuple[str, str]:
    ...
    if melt_flag or avg_snow_f >= 31.3 or (max_air_f > 32.0 and max(start_snow_f, finish_snow_f) >= 31.0):
        return (
            "Wet suction / free water",
            "Surface is at or near melting with above-freezing air, so liquid water and suction dominate glide.",
        )
    if avg_snow_f >= 26.0 or (snow_type in {"Coarse / transformed / artificial", "Injected / icy"} and avg_air_f >= 27.0) or (rh >= 80 and avg_snow_f >= 24.0):
        return (
            "Transitional mixed",
            "Near-freezing snow suggests mixed dry friction and emerging wet-suction behavior.",
        )
    return (
        "Cold dry friction",
        "Snow remains below freezing enough that dry friction and crystal interaction dominate glide.",
    )
